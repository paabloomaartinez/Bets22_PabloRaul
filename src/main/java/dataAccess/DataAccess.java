...
public class DataAccess  {
	...
	ConfigXML c=ConfigXML.getInstance();
     ...
     public DataAccess(boolean initializeMode)  {
		...
		System.out.println("Creating DataAccess instance => isDatabaseLocal:"+ initializeMode);
		open(initializeMode);
	...
	public void open(boolean initializeMode){
		...
		System.out.println("Opening DataAccess instance => isDatabaseRemote: "+ initializeMode);

		String fileName=c.getDbFilename();
		
		if (!initializeMode) {
			System.out.println("Creating BLFacadeImplementation instance [Server mode]");
			fileName=fileName+";drop";
			System.out.println("Deleting the DataBase");
			emf = Persistence.createEntityManagerFactory("objectdb:"+fileName);
			db = emf.createEntityManager();
		} else {
			System.out.println("Creating BLFacadeImplementation instance with DataAccess parameter [Local mode]");
