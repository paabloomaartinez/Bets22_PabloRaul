...
public class RegisteredGUI extends JFrame {
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			JButton btnNewButton_1 = new JButton(); //$NON-NLS-1$ //$NON-NLS-2$
			...
			btnNewButton_1.setText(ResourceBundle.getBundle("Etiquetas").getString("RegisteredGUI.btnNewButton_1.text")); //$NON-NLS-1$ //$NON-NLS-2$
